...
public class Texture2dProgram {
    ...
    public enum ProgramType {
        TEXTURE_2D, TEXTURE_EXT, TEXTURE_EXT_BW, TEXTURE_EXT_FILT, TEXTURE_EXT_BRIGHT
    }
...
//            "    gl_FragColor = vec4(color, color, color, 1.0);\n" +
            "    float colorR = (textureColor.r) * saturation + bright;\n" +
            "    float colorG = (textureColor.g) * saturation + bright;\n" +
            "    float colorB = (textureColor.b) * saturation + bright;\n" +
    ...
    public static final String SOFT_LIGHT_BLEND_FRAGMENT_SHADER =
            ...
            "     \n" +
            "     gl_FragColor = base * (overlay.a * (base / base.a) + (2.2  * overlay * (1.0 - (base / base.a)))) + overlay * (1.0 - base.a) + base * (2.0 - overlay.a);\n" +
            " }\n";
    ...
    public Texture2dProgram(ProgramType programType) {
        ...
        switch (programType) {
            ...
            case TEXTURE_EXT_FILT:
                ...
                break;
            case TEXTURE_EXT_BRIGHT:
                mTextureTarget = GLES11Ext.GL_TEXTURE_EXTERNAL_OES;
                mProgramHandle = GlUtil.createProgram(VERTEX_SHADER, BRIGHTNESS_FRAGMENT_SHADER);
                break;
            default:
        ...
        TLLogger.trace(TAG, "Created program " + mProgramHandle + " (" + programType + ")");
     ...
     */
    public void release() {
        TLLogger.trace(TAG, "deleting program " + mProgramHandle);
    ...
    public void changeMode(ProgramType programType){
        mProgramType = programType;
