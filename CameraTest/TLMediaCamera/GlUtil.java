...
public class GlUtil {
    ...
    public static void logVersionInfo() {
        TLLogger.trace(TAG, "vendor  : " + GLES20.glGetString(GLES20.GL_VENDOR));
        TLLogger.trace(TAG, "renderer: " + GLES20.glGetString(GLES20.GL_RENDERER));
        TLLogger.trace(TAG, "version : " + GLES20.glGetString(GLES20.GL_VERSION));
        ...
        if (false) {
            ...
            if (GLES30.glGetError() == GLES30.GL_NO_ERROR) {
                TLLogger.trace(TAG, "iversion: " + majorVersion + "." + minorVersion);
            }
        }
    }
}
